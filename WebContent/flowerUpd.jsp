...
<div class="r">
    ...
    <div class="r1"><div class="r11">修改花卉...</div></div>
    <div class="r2">
    <center><h2>修改花卉</h2>（*号的是填数字）</center>
    
	<s:form  action="flrupd" method="post" class="f" > 
      <table width="300" border="0"  align="center">
        <tr>
          <td><s:textfield  name="f.fid" label="请输入id" /></td>
       </tr>
        <tr>
